...
$env:DEEPSEEK_API_KEY="sk-1b631e523c14451389fa24649807ff0d"

python openevolve-run.py hadwiger-nelson-problem/initial_program.py `
  hadwiger-nelson-problem/evaluator.py `
  --config hadwiger-nelson-problem/config.yaml `
  --iterations 10
```
